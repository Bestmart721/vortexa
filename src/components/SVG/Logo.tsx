...
const Logo = ({ width = "50px", height = "50px", className = "" }: Props) => {
    return (
        <svg
            ...
            ></path>
            <path
                fill="url(#paint1_radial_635_218)"
            ...
            ></path>
            <path
                fill="url(#paint2_radial_635_218)"
            ...
            ></path>
            <path
                fill="url(#paint3_radial_635_218)"
            ...
            ></path>
            <path
                fill="url(#paint4_radial_635_218)"
            ...
            ></path>
            <path
                fill="url(#paint5_radial_635_218)"
